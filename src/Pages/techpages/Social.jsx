      ...
      <div className="page mt-32 p-5  flex-wrap rounded-[4rem] h-screen w-[90vw] m-auto">
        ...
        <div className="back flex items-center">
          ...
          >
            ...
            <h1 className="text-white font-mono text-xl">Social Media Management</h1>
          </motion.div>
        </div>
        <div className="mini-card mt-10 rounded-[4rem] flex flex-wrap flex-col md:flex-row lg:flex-row gap-5">
          <div
            ...
            className="card1 card-shine-effect md:w-1/3 p-5 hover:h-[33vh] hover:md:h-[32vh] hover:items-start  transition-all duration-500 w-full  flex justify-center  items-center rounded-[4rem] h-[10vh]"
          >
            <div className="transition-all p-2 rounded-[2rem] duration-500 flex flex-col gap-5 items-center md:items-center lg:items-center justify-center">
              <div className="logo  flex items-center gap-5">
                ...
                <h1 className="text-white text-xl">Lead Generation</h1>
              </div>
              {hover && (
          ...
          <div
            ...
            className="card1 card-shine-effect p-5 md:w-[50vw] hover:h-[37vh] hover:md:h-[29vh] hover:items-start transition-all duration-500 w-full border-2 flex justify-center items-center  rounded-[4rem] h-[10vh]"
          >
            <div className="transition-all  duration-500 flex-col flex gap-5 items-center md:items-center lg:items-center justify-center">
              <div className="logo flex gap-5 items-center">
                ...
                <h1 className="text-white  text-xl">Social Media Marketing</h1>
              </div>
              {hover1 && (
                <p className="text-white text-wrap">
          ...
          <div
            ...
            className="card1 card-shine-effect p-5 hover:md:h-[34vh] md:w-[40vw] hover:h-[40vh] hover:items-start transition-all duration-500 w-full border-2 flex justify-center items-center  rounded-[4rem] h-[10vh]"
          >
            <div className="transition-all duration-500 flex-col flex gap-5 items-center md:items-center lg:items-center justify-center">
              <div className="logo flex gap-5 items-center">
                <img src={seo} alt="Web" height={60} width={60} />
                <h1 className="text-white  text-xl">Search Engine Optimization</h1>
              </div>
              {hover3 && (
                <p className="text-white text-wrap">
          ...
          <div
            ...
            className="card1 card-shine-effect p-5 hover:md:h-[34vh] md:w-[33vw] hover:h-[38vh] hover:items-start transition-all duration-500 w-full border-2 flex justify-center items-center  rounded-[4rem] h-[10vh]">
            <div className="transition-all duration-500 flex-col flex gap-5 items-center md:items-center lg:items-center justify-center">
              <div className="logo flex gap-5 items-center">
                <img src={comm} alt="Web" height={60} width={60} />
                <h1 className="text-white  text-xl">Community Management</h1>
              </div>
              {hover2 && (
                <p className="text-white text-wrap">
          ...
          <div
            ...
            className="card1 m-auto card-shine-effect hover:md:h-[34vh] p-5 md:w-[33vw] hover:h-[34vh] hover:items-start transition-all duration-500 w-full border-2 flex justify-center items-center  rounded-[4rem] h-[10vh]">
            <div className="transition-all duration-500 flex-col flex gap-5 items-center md:items-center lg:items-center justify-center">
              <div className="logo  flex gap-5 justify-between items-center">
                <img src={paid} alt="Web" height={60} width={60} />
                <h1 className="text-white   text-xl">Paid Colaboration</h1>
              </div>
              {hover4 && (
                <p className="text-white text-wrap">
